      ...
      <div className="col-lg-3 d-lg-block">
          ...
          <div className="card border-1">
            <div className="news-media mb-3">
              <div
                ...
                style={{
                  backgroundImage: "url(../assets/img/food/headphones.jpg)"
                }}
              />
            </div>
        ...
        <div className="news mb-5">
          <div className="card border-1">
            ...
            <div className="row m-0">
              <div className="fw-bold fs-16px col-7 text-gray-600">Bottle</div>
              <div className="col-auto fw-bold text-end align-self-center text-gray-600">
                100 points
              </div>
            </div>
        ...
        <div className="news mb-5">
          <div className="card border-1">
            ...
            <div className="row m-0">
              <div className="fw-bold fs-16px col-7 text-gray-600">Jersey</div>
              <div className="col-auto fw-bold text-end align-self-center text-gray-600">
                100 points
              </div>
            </div>
                ...
                <div className="card border-1">
                  <div className="news-media mb-3">
                    <div
                      className="news-media-img news-media-img-lg"
                      style={{
                        backgroundImage: "url(../assets/img/food/amazon.jpg)"
                      }}
                    ></div>
                  </div>
                  <div className="row m-0">
                ...
                <div className="card border-1">
                  <div className="news-media mb-3">
                    <div
                      className="news-media-img news-media-img-lg"
                      style={{
                        backgroundImage: "url(../assets/img/food/hat.jpg)"
                      }}
                    />
                  </div>
                  <div className="row m-0">
                ...
                <div className="card border-1">
                  <div className="news-media mb-3">
                    <div
                      className="news-media-img news-media-img-lg"
                      style={{
                        backgroundImage: "url(../assets/img/food/zomato.jpg)"
                      }}
                    ></div>
                  </div>
              ...
              <div className="col-sm-3 col-6">
                <div className="input-group qty">
                  <div className="input-group-append">
                    <a href="#" className="btn btn-default rounded-pill">
