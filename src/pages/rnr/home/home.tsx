                ...
                <div className="card-body p-4">
                  <div className="row">
                    ...
                    <div className="col-8 text-start align-self-center">
                      ...
                      <p className="widget-list-desc">Recognized 3 days ago</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-3">
                    ...
                    <div className="col-8 text-start align-self-center">
                      ...
                      <p className="widget-list-desc">Recognized 5 days ago</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-3">
                    ...
                    <div className="col-8 text-start align-self-center">
                      ...
                      <p className="widget-list-desc">Recognized 2 days ago</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-3">
                  ...
                  <div className="row">
                    ...
                    <div className="col-8 text-start align-self-center">
                      <h5 className="widget-list-title text-vinous">Shwetha</h5>
                  ...
                  <div className="row">
                    ...
                    <div className="col-8 text-start align-self-center">
                      <h5 className="widget-list-title text-vinous">Harshan</h5>
                      <p className="widget-list-desc">
                ...
                <div className="d-flex mb-2">
                  ...
                  <div className="card py-2 ms-2 ">
                    ...
                    <p className="px-2">
                      ...
                      great developer and I would like to Recommened her to your
                      upcoming project.
                    </p>
                    <b className="px-2 text-vinous">#TeamWork #LederShip</b>
                    <p className="px-2">
                ...
                <div className="card-body p-4">
                  ...
                  <div className="row">
                    ...
                    <div className="col-6 text-start align-self-center">
                      ...
                      <p className="widget-list-desc">Recognized 1 week ago</p>
                    </div>
                    <div className="col-3">
                      <img src="../assets/img/icon/Vectorhand.svg" alt="" />
                    </div>
