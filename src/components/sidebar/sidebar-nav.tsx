      ...
      if (elms4) {
        elms4.map(function (elm) {
          ...
          if (targetText.search(targetValue) > -1) {
            ...
            if (targetElm2) {
              var targetElm3 = targetElm.querySelector(
            ...
            if (targetElm4) {
              ...
              var targetElm5 = targetElm.querySelector(
