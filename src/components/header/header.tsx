...
import DropdownNotification from './dropdown/notification.tsx';
import DropdownLanguage from './dropdown/language.tsx';
import DropdownProfile from './dropdown/profile.tsx';
import SearchForm from './search/form.tsx';
import DropdownMegaMenu from './dropdown/mega.tsx';
			...
			{({toggleAppSidebarMobile, toggleAppSidebarEnd, toggleAppSidebarEndMobile, toggleAppTopMenuMobile, appHeaderLanguageBar, appHeaderMegaMenu, appHeaderInverse, appSidebarTwo, appTopMenu, appSidebarNone}) => (
				<div id="header" className="app-header" data-bs-theme={appHeaderInverse ? 'dark' : ''}>
					<div className="navbar-header">
						...
						{/* <Link to="/" className="navbar-brand"><span className="navbar-logo"></span> <b>Pearl</b> Connect</Link> */}
