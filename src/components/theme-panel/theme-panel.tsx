...
function ThemePanel() {
	...
	function handleHeaderFixed(e:any) {
		if (e.target.checked) {
	...
	function handleSidebarFixed(e:any) {
		if (e.target.checked) {
	...
	function handleHeaderInverse(e:any) {
		if (e.target.checked) {
	...
	function handleSidebarGrid(e:any) {
		if (e.target.checked) {
	...
	function handleGradientEnabled(e:any) {
		if (e.target.checked) {
