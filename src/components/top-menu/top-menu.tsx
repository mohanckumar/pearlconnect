...
function handleUnlimitedTopMenuRender() {
  ...
  function handlePageLoadMenuFocus() {
    ...
    var viewWidth = document.querySelector<any>(".app-top-menu").clientWidth;
    var prevWidth = 0;
    var fullWidth = 0;
  ...
  function enableFluidContainerDrag(containerClassName: any) {
    ...
    let startX: any, scrollLeft: any, mouseDown: any;
    let menuWidth = 0;
    let maxScroll = 0;

    menuItem.forEach((element: any) => {
...
function TopMenu() {
  ...
  return (
    <React.Fragment>
      <div id="top-nav" className="app-top-menu" data-bs-theme="light">
        <TopMenuNav />
      </div>
    </React.Fragment>
  );
