...
function TopMenuNav() {
	...
	function handlePageLoadMenuFocus() {
		var targetMenu = document.querySelector<any>('.app-top-menu .menu');
		if (!targetMenu) {
			return;
		}
		var bodyStyle = window.getComputedStyle(document.body);
		var viewWidth = document.querySelector<any>('.app-top-menu').clientWidth - 128;
		var prevWidth = 0;
		var fullWidth = 0;
	...
	function handleMenuButtonAction(elm:any, direction:any) {
		var element = elm.target;
		var obj = element.closest('.menu');
		var objStyle = window.getComputedStyle(obj);
		var bodyStyle = window.getComputedStyle(document.querySelector<any>('body'));
		...
		var containerWidth = document.querySelector<any>('.app-top-menu').clientWidth - 80;
		var totalWidth = 0;
	...
	function handleTopMenuToggle(menus:any, forMobile = false) {
	...
	function controlRight(e:any) {
		e.preventDefault();
		handleMenuButtonAction(e, 'next');
	}

	function controlLeft(e:any) {
		e.preventDefault();
